...
public class AntiDreadnoughtStats : MonoBehaviour {

	// Fields
	public float damage = 4;
	public float rateOfFire = 5;
	public float range = 6;
	public float integrity = 3;
	public float max_integrity = 3;
	public float shield = 15;
	public float max_shield = 15;
	public float penetration = 1.4f;
	public float shieldResist = 0.5f;
